module clm_varctl
  ...
  logical, public            :: use_fates_hydrohard = .false.         ! true => turn on fates hydrohard !marius
  logical, public            :: use_fates_frosthard = .false.         ! true => turn on fates frosthard !marius
